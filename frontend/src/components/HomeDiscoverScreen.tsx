    ...
    return (
        <div className='h-max bg-gray px-3 py-3 relative'>
            <div className='text-right relative pb-3 '>
                ...
                {
                    isMenuOpen &&
                    <div className="bg-gray p-2 text-white absolute right-0 z-10 w-48 origin-top-right py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none text-left space-y-2" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button">
